...
\subsubsection{Derivation of the Mixed-Precision Criterion (\texttt{preuve\_arrondi.pdf} \& \texttt{arrondi\_complet.pdf})}
...
\textbf{Conclusion -- Unified element-wise precision criterion} (\texttt{preuve\_arrondi.pdf} \& \texttt{arrondi\_complet.pdf}):
